// https://raw.githubusercontent.com/monsonite/ChipStick/master/simplex_2_MSP430FR2433_5.c
#include <msp430.h> 
// SIMPLEX 2_MSP430FR2433_5
...
// SIMPL Interpreter for MSP430FR2433 ChipStick
...
void GPIO_init_2433()
{
  ...
  P1OUT = 0x01; P2OUT = 0x00; P3OUT = 0x01;
}
...
// --------------------------------------------------------------------------------------------------------------------
       ...
       // spi_init_4133();                                   // Initialise the '4133 SPI on USCIB  8MHz clock, master mode
        ...
        P1DIR  = BIT0; 		              // P1.0 is the green LED
        P1OUT  = BIT0; 		              // All LEDs off

        P3DIR  = BIT0; 		              // P1.0 is the RED LED
        P3OUT  |= BIT0; 		              // RED LEDs on
